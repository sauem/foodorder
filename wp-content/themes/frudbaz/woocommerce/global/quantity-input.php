...
if ($max_value && $min_value === $max_value) {
    ...
    $labelledby = !empty($args['product_name']) ? sprintf(esc_html__('%s quantity', 'frudbaz'), strip_tags($args['product_name'])) : '';
    ?>
    <div class="product-quantity">
        <div class="cart-plus-minus">
        <input type="text" id="<?php echo esc_attr($input_id); ?>" class="product-count input-text qty text"
                ...
                title="<?php echo esc_attr_x('Qty', 'Product quantity input tooltip', 'frudbaz'); ?>"
