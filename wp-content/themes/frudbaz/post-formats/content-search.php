    ...
    <div class="post_content">
        ...
        <ul class="post_btn mt-20 ul_li">
            ...
            <?php
                if ( 'product' == get_post_type() ) :
                if ( rtl_enable() ) {
                    $frudbaz_blog_btn = get_theme_mod( 'frudbaz_blog_btn_rtl', esc_html__( 'View Product', 'frudbaz' ) );
                } else {
                    $frudbaz_blog_btn = get_theme_mod( 'frudbaz_blog_btn', esc_html__( 'View Product', 'frudbaz' ) );
                }
