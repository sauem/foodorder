 ...
 */
    ...
    $frudbaz_audio_url = function_exists( 'get_field' ) ? get_field( 'fromate_style' ) : NULL;
...
?>
    ...
    <div class="post_content mb-30">
        <?php if ( !empty( $frudbaz_audio_url ) ): ?>
            <div class="postbox__audio embed-responsive mb-30">
                <?php echo wp_oembed_get( $frudbaz_audio_url ); ?>
            </div>
        <?php endif; ?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'post_item format_audio' );?>>
        <?php if ( !empty( $frudbaz_audio_url ) ): ?>
