...
class Element_El_Select2_Handler {

	public static function init () {
		
		add_action( 'wp_ajax_elh_element_post_list_query', [ __CLASS__, 'elh_element_post_list_query' ] );
		add_action( 'wp_ajax_elh_element_post_tab_select_query', [ __CLASS__, 'post_tab_query' ] );
	}

	/**
	 * Return Post list based on post type
	 */
	public static function elh_element_post_list_query () {

		$security = check_ajax_referer( 'elh_element_Select2_Secret', 'security' );
		if ( ! $security ) return;
