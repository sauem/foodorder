...
class Statistic_Info extends Element_El_Widget {
    ...
    public function get_title() {
        return __( 'Statistic Info', 'elementhelper' );
    }
    ...
    public function get_icon() {
        return 'elh-widget-icon eicon-info-box';
    }
	...
	protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Statistic Info', 'elementhelper' ),
        ...
        $this->add_control(
            'content_off',
            [
                'label' => __( 'Content on/off', 'elementhelper' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Statictic Info', 'elementhelper' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Countr Number here', 'elementhelper' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'show_label' => false,
                'placeholder' => __( 'Content here', 'elementhelper' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
	...
	protected function render() {
        ...
        $this->add_render_attribute( 'title', 'class', 'elh-infobox-title' );
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        <div class="statistics-content mb-30">
                            ...
                            ?>
                            <figure class="elh-infobox-figure elh-infobox-figure--image">
                                <?php echo Group_Control_Image_Size::get_attachment_image_html( $settings, 'thumbnail', 'image' ); ?>
                            </figure>
                        <?php elseif ( ! empty( $settings['icon'] ) || ! empty( $settings['selected_icon']['value'] ) ) : ?>
                            <figure class="elh-infobox-figure elh-infobox-figure--icon">
                        ...
                        <?php elseif ( $settings['button_text'] && ( ! empty( $settings['button_icon'] ) || ! empty( $settings['button_selected_icon'] ) ) ) :
                            if ( $settings['button_icon_position'] === 'before' ) :
                                ...
                                ?>
                                <a <?php $this->print_render_attribute_string( 'button' ); ?>><?php elh_element_render_icon( $settings, 'button_icon', 'button_selected_icon', ['class' => 'btn-icon'] ); ?> <?php echo $button_text; ?></a>
                                <?php
                            else :
                                $this->add_render_attribute( 'button', 'class', 'btn--icon-after' );
                                $button_text = sprintf( '<span %1$s>%2$s</span>', $this->get_render_attribute_string( 'button_text' ), esc_html( $settings['button_text'] ) );
                                ?>
                                <a <?php $this->print_render_attribute_string( 'button' ); ?>><?php echo $button_text; ?> <?php elh_element_render_icon( $settings, 'button_icon', 'button_selected_icon', ['class' => 'btn-icon'] ); ?></a>
                                <?php
                            endif;
                        endif;
                        ?>
                                ...
                                <div class="col-lg-<?php echo esc_attr($slider_number); ?> col-md-<?php echo esc_attr($slider_number); ?> col-sm-6 sta-col">
                                    <div class="statistics-wrapper mb-80">
                                        <div class="statistics-text">
                                            ...
                                            <h2>
                                                <span><?php echo elh_element_kses_basic( $slide['stat_number'] ); ?> <br><?php echo elh_element_kses_basic( $slide['stat_content'] ); ?></span>
                                            </h2>
                                            <?php endif; ?>
                                        </div>
                                    </div>
