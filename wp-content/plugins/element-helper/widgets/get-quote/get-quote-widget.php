...
class Get_Quote extends Element_El_Widget {
    ...
    public function get_title() {
        return __( 'Get Quote', 'elementhelper' );
    }
    ...
    public function get_icon() {
        return 'elh-widget-icon eicon-menu-bar';
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Elhsub title here', 'elementhelper' ),
        ...
        $this->add_control(
            'link',
            [
                'label' => __( 'Box Link', 'elementhelper' ),
                'separator' => 'before',
    ...
    protected function register_style_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'title',
                'selector' => '{{WRAPPER}} .elh-gradient-heading',
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'button_text', 'class', 'site-btn-text' );
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-10">
                        <div class="section-heading">
                            ...
                            <h4 <?php $this->print_render_attribute_string( 'sub_title' ); ?>><?php echo elh_element_kses_intermediate( $settings['sub_title'] ); ?></h4>
                            <?php endif; ?>
                    ...
                    <div class="col-xl-3 col-lg-6 my-auto text-right">
                        ...
                        <?php elseif ( $settings['button_text'] && ( ! ( empty( $settings['button_selected_icon'] ) || empty( $settings['button_selected_icon']['value'] ) ) || ! empty( $settings['button_icon'] ) ) ) :
                            if ( $settings['button_icon_position'] === 'before' ) :
                                $this->add_render_attribute( 'button', 'class', 'elh-btn--icon-before' );
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="appointment-box appointment-box-2">
                            ...
                            <div class="appointment-ilustration">
                                <img src="assets/images/ilustration/ilustration-2.png" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
