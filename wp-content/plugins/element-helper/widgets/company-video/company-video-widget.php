...
class Company_Video extends Element_El_Widget {
    ...
    public function get_title() {
        return __( 'Comapny Video', 'elementhelper' );
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Big Title', 'elementhelper' ),
                'placeholder' => __( 'Big Title', 'elementhelper' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->start_controls_section(
            '_section_profile',
            [
                'label' => __( 'Profile Info', 'elementhelper' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'profile_title',
            [
                'label' => __( 'Profile Title', 'elementhelper' ),
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'ElhInfo Box Title', 'elementhelper' ),
                'placeholder' => __( 'Type Info Box Title', 'elementhelper' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Shadow Title', 'elementhelper' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Type Video URL Here', 'elementhelper' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
    ...
    protected function register_style_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Icon / profile_image', 'elementhelper' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .elh-infobox-figure--profile_image img, {{WRAPPER}} .about-thumb-wrap i' => 'padding: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'media_border',
                'selector' => '{{WRAPPER}} .elh-infobox-figure--profile_image img, {{WRAPPER}} .about-thumb-wrap i',
            ]
        );
                        ...
                        <div class="whoweare_content whoweare_content-video"> 
                            <div class="section_title mb_50 wow fadeInUp2" data-wow-delay=".2s">
                                <?php if( !empty($settings['subtitle']) ): ?>
                                    <h4 class="small_title"><?php echo elh_element_kses_basic( $settings['subtitle'] ); ?></h4>
                                <?php endif; ?>
                                ...
                                <div class="avatar_wrap">
                                    ...
                                    <div class="avatar_content">
                                        <?php if( !empty($settings['profile_title']) ): ?>
                                            <h4 class="avatar_name"><?php echo elh_element_kses_basic( $settings['profile_title'] ); ?></h4>
                                        <?php endif; ?>
                                        <?php if ( !empty($settings['profile_designation']) ) : ?>
                                            <span class="avatar_title"><?php echo elh_element_kses_basic( $settings['profile_designation'] ); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
